...
public class SSLContextUtil {
    ...
    public static SSLContext getSSLContext() {
        ...
        /*try {
            ...
            InputStream inputStream = MyApplication.getInstance().getAssets().open("app.cer");
     ...
     */
    @SuppressLint("TrulyRandom")
    public static SSLContext getMqttSSLContext() {
        SSLContext sslContext = null;
        try {
            sslContext = SSLContext.getInstance("TLS");
            InputStream inputStream = MyApplication.getInstance().getAssets().open("mqtt.bks");

            KeyStore keyStore = KeyStore.getInstance("BKS");
            keyStore.load(inputStream, "mqtt#@123".toCharArray());
